...
public class ImageDisplayActivity extends ActionBarActivity {
    @InjectView(R.id.ivImageResult) ImageView ivImageResult;
    ...
    public void onShareItem() {
        ...
        if (bmpUri != null) {
            ...
            Toast toast = Toast.makeText(ImageDisplayActivity.this,
                "An error occurred when trying to share this image ",
                Toast.LENGTH_SHORT);
            toast.show();
        }
    }
